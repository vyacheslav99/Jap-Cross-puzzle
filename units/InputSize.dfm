object frmInputSize: TfrmInputSize
  Left = 0
  Top = 0
  BorderStyle = bsToolWindow
  Caption = #1042#1074#1077#1076#1080#1090#1077' '#1088#1072#1079#1084#1077#1088#1099' '#1082#1088#1086#1089#1089#1074#1086#1088#1076#1072
  ClientHeight = 83
  ClientWidth = 199
  Color = clBtnFace
